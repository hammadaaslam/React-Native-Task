...
const Turku = () => {
  ...
  return (
    ...
    <View style={{flex:1,justifyContent:'center',alignItems:'center',backgroundColor:'#fff'}}>
      ...
      <Text style={{fontSize:17,color:'grey',fontWeight:'bold'}}>Helsinki (5)</Text>
      ...
      <Text style={{fontSize:17,color:'grey',fontWeight:'bold'}}>Tampere (8)</Text>
      ...
      <Text style={{fontSize:17,color:'#004FB4',fontWeight:'bold'}}>Turku (5)</Text>
